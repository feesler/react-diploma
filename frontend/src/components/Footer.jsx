      ...
      <div className="row">
        <div className="col">
          <section>
            ...
            <ul className="nav flex-column">
              <li className="nav-item"><Link className="nav-link" to="/about.html">О магазине</Link></li>
              <li className="nav-item"><Link className="nav-link" to="/catalog.html">Каталог</Link></li>
              <li className="nav-item"><Link className="nav-link" to="/contacts.html">Контакты</Link></li>
            </ul>
          </section>
        </div>
        <div className="col">
        ...
        <div className="col text-right">
          <section className="footer-contacts">
            ...
            <a className="footer-contacts-email" href="mailto:{contacts.email}">{contacts.email}</a>
